...
<html>
<head>
<title>Hero's Journey Knight Character Generator Version 3</title>
 
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    
	<meta charset="UTF-8">
	<meta name="description" content="Hero's Journey knight Character Generator. Gallant Knight Games.">
	...
	<link rel="stylesheet" type="text/css" href="css/knight.css">
...
<body>
    ...
    include 'php/goldPieces.php';
        ...
        $knightMessage = knightMessage();
        $squire = squire($bearing, $level);
