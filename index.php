...
<html>
<head>
<title>Launch Page: The Hero's Journey 2e Knight Character Generator Version 3</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="The Hero's Journey 2e Knight Character Generator Version 3" class="image" /></h1>
        ...
        <p><a href="https://www.oldschooladventures.org/hero/more/classes/knight/"  class="text_link" target="_blank"><span class="bold">Humble Beginnings and Bold Adventures: A Hero's Journey Fan Site</span></a></p>
        ...
        <form action="" id ="KnightFormV3"  target="_blank" method="post">
    ...
    <br/>
        ...
        $("#generate_charactersWarriorV3").click(function(){
         ...
         $("#KnightFormV3").attr('action', "character/hjKnight.php");
